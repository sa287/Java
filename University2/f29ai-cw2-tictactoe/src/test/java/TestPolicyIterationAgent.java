...
import ticTacToe.PolicyIterationAgent2;
...
public class TestPolicyIterationAgent {
	...
	public void testDefensive() {
		...
		int[] results=playAgainstEachOther(new PolicyIterationAgent2(), new DefensiveAgent(), 50);
	...
	public void testAggressive() {
		...
		int[] results=playAgainstEachOther(new PolicyIterationAgent2(), new AggressiveAgent(), 50);
		System.out.println("Wins: " + results[0] + " Losses: " + results[1] + " Draws: " + results[2]);
		assertEquals(0, results[1]);
	...
	public void testRandom() {
		...
		int[] results=playAgainstEachOther(new PolicyIterationAgent2(), new RandomAgent(), 50);
