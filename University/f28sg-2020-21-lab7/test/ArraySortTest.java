...
//insertion and bubblesort tests add an array with numbers that are ordered/unordered dependant on whats being tested. It will then ask the
	// sort function to sort them accordingly, and then test the output size and order using assertions, and the isSorted function.
	@Test
...
// creates ArrayList and adds values to it, ordered and unordered depending on whats being tested. creates a new arrayList that
// the result of quickSort function being done to arr, and then do assertions on it.
	@Test
